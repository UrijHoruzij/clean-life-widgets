...
class Tag_Cloud extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'description'                 => __( 'A cloud of your most used tags.','clean-life' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'tag_cloud', __( 'Tag Cloud','clean-life' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		echo '<p><label for="' . $title_id . '">' . __( 'Title:','clean-life' ) . '</label>
		...
		switch ( count( $taxonomies ) ) {
			...
			case 0:
				echo '<p>' . __( 'The tag cloud will not be displayed since there are no taxonomies that support the tag cloud widget.','clean-life' ) . '</p>';
				printf( $input, '' );
				break;
