 ...
 * @see WP_Widget
 */
class Widget_Media_Image extends Widget_Media {
	...
	public function __construct() {
		parent::__construct(
			'media_image',
			__( 'Image','clean-life-widgets'),
			array(
				'description' => __( 'Displays an image.','clean-life-widgets' ),
				'mime_type'   => 'image',
			)
		);
		...
		$this->l10n = array_merge(
			$this->l10n,
			array(
				'no_media_selected'          => __( 'No image selected','clean-life-widgets'),
				'add_media'                  => _x( 'Add Image', 'label for button in the image widget','clean-life-widgets' ),
				'replace_media'              => _x( 'Replace Image', 'label for button in the image widget; should preferably not be longer than ~13 characters long','clean-life-widgets' ),
				'edit_media'                 => _x( 'Edit Image', 'label for button in the image widget; should preferably not be longer than ~13 characters long','clean-life-widgets' ),
				'missing_attachment'         => sprintf(
					/* translators: %s: URL to media library */
					__( 'We can&#8217;t find that image. Check your <a href="%s">media library</a> and make sure it wasn&#8217;t deleted.','clean-life-widgets' ),
					esc_url( admin_url( 'upload.php' ) )
				),
				/* translators: %d: widget count */
				'media_library_state_multi'  => _n_noop( 'Image Widget (%d)', 'Image Widget (%d)','clean-life-widgets' ),
				'media_library_state_single' => __( 'Image Widget','clean-life-widgets' ),
			)
		);
	}
		...
		return array_merge(
			array(
				...
				'caption'           => array(
					...
					'description'           => __( 'Caption','clean-life-widgets'),
				...
				'alt'               => array(
					...
					'description'       => __( 'Alternative Text','clean-life-widgets' ),
				),
				'link_type'         => array(
					'type'                  => 'string',
					...
					'default'               => 'custom',
					'media_prop'            => 'link',
					'description'           => __( 'Link To','clean-life-widgets' ),
				...
				'link_url'          => array(
					...
					'format'                => 'uri',
					'media_prop'            => 'linkUrl',
					'description'           => __( 'URL','clean-life-widgets' ),
					'should_preview_update' => true,
				),
				'image_classes'     => array(
					'type'                  => 'string',
					...
					'description'           => __( 'Image CSS Class','clean-life-widgets' ),
					'should_preview_update' => false,
				),
				'link_classes'      => array(
					'type'                  => 'string',
					...
					'should_preview_update' => false,
					'description'           => __( 'Link CSS Class','clean-life-widgets' ),
				),
				'link_rel'          => array(
					'type'                  => 'string',
					'default'               => '',
					'sanitize_callback'     => array( $this, 'sanitize_token_list' ),
					'media_prop'            => 'linkRel',
					'description'           => __( 'Link Rel','clean-life-widgets' ),
					'should_preview_update' => false,
				),
				'link_target_blank' => array(
					...
					'description'           => __( 'Open link in a new tab','clean-life-widgets' ),
					'should_preview_update' => false,
				),
				'image_title'       => array(
					'type'                  => 'string',
					...
					'sanitize_callback'     => 'sanitize_text_field',
					'media_prop'            => 'title',
					'description'           => __( 'Image Title Attribute','clean-life-widgets' ),
					'should_preview_update' => false,
				),
	...
	public function render_media( $instance ) {
		...
		if ( $attachment ) {
			...
			$image_attributes = array(
				'class' => sprintf( 'image baner__img wp-image-%d %s', $attachment->ID, $instance['image_classes'] ),
					...
					<# if ( ! data.alt && data.currentFilename ) { #>
						...
						echo esc_attr(
							sprintf(
								...
								__( 'The current image has no alternative text. The file name is: %s', 'clean-life-widgets'),
